            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-7 mt-4">
                {
                    projects?.map(project => (
                        ...
                        <div key={project.id} className="relative group  ">
                            ...
                            <div className="absolute inset-0  transition-normal hidden  md:flex gap-4 flex-col items-center justify-center opacity-0 group-hover:opacity-90 transition-opacity duration-200">
                            ...
                            <div className="flex justify-center gap-1 md:hidden">
                                <Link href={project.live_link} target="_blank">
                                    <button className="rounded-sm cursor-pointer w-11 h-4 text-xs bg-orange-400">Live</button>
                                </Link>
                                <Link href={project.client} target="_blank">
                                    <button className="rounded-sm cursor-pointer w-11 h-4 text-xs bg-sky-400">Client</button>
                                </Link>
                                <Link href={project.server} target="_blank">
                                    <button className="rounded-sm cursor-pointer w-11 h-4 text-xs bg-purple-400">Server</button>
                                </Link>
